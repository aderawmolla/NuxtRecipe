        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <div class="container mx-auto px-4 py-8">
            ...
            <fieldset class="bg-gray-50 p-6 rounded-md shadow-sm mb-8">
             ...
             <div class="mb-8">
              <label for="categories" class="block text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2">Categories</label>
              <multiselect
                ...
                class="w-full border border-gray-300 dark:border-gray-700 rounded-md p-3 text-sm placeholder-gray-500 dark:placeholder-gray-400"
              ></multiselect>
              <button type="button" @click="addCategory" class="btn px-8 py-3 font-semibold border rounded dark:border-gray-100 dark:text-gray-100 mt-4">
                <i class="mr-2 fa-solid fa-plus"></i>Add Category
              </button>
              <input
                v-model="newCategory"
                type="text"
                class="mt-2 w-full border border-gray-300 dark:border-gray-700 rounded-md p-3 text-sm placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <fieldset class="bg-gray-50 p-6 rounded-md shadow-sm mb-8">
              ...
              <input
                ...
                class="w-full border-2 border-dashed border-gray-300 rounded-md p-4 text-gray-600 bg-gray-100"
              />
              <div class="mt-4 flex flex-wrap gap-4">
                ...
                >
                  ...
                  <button
                    ...
                    class="absolute top-0 right-0 m-1 text-red-600 hover:text-red-800"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="w-5 h-5"
