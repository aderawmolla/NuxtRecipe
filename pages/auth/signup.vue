<template>
	<div class="flex flex-col max-w-md p-6 rounded-md sm:p-10 dark:bg-gray-50 dark:text-gray-800">
		...
		<form  action="" class="space-y-12">
			...
			<div class="space-y-2">
				<div>
					<button type="button" class="w-full px-8 py-3 font-semibold rounded-md dark:bg-orange-600 dark:text-gray-50">Sign in</button>
				</div>
				<p class="px-6 text-sm text-center dark:text-gray-600">Don't have an account yet?
					<a rel="noopener noreferrer" href="#" class="hover:underline dark:text-orange-600">Sign up</a>.
				</p>
			</div>
		</form>
	</div>
